...
There are some outliers in the data set (someone copied a story and had multiple same entries). So we removed these answers from the data set.
...
Words are ordered by their fruencies.
...
Surprisingly, single dads have the highest postivity score. Another interesting fact is that for female, married women have similar or slight higher positivity score with unmarried women. However, the scenerio is opposite for male. Perhaps it is because women enjoy marriage more than men.
...
Coffee and Pizza are the secret food/drink to happiness. Sweet dessert like ice cream, chocolate, cake can also give a sense of sweetness to our lives.
